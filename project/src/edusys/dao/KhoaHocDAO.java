...
public class KhoaHocDAO extends EduSysDAO<KhoaHoc, Integer> {
    ...
    public void insert(KhoaHoc model) {
        String sql = "INSERT INTO KhoaHoc (MaCD, HocPhi, ThoiLuong, NgayKG,"
                + " GhiChu, MaNV) VALUES (?, ?, ?, ?, ?, ?)";
        XJdbc.update(sql,
                model.getMaCD(),
                model.getHocPhi(),
    ...
    @Override
    public List<KhoaHoc> selectSqlJTable() {
        return null;
    }

    @Override
    protected List<KhoaHoc> listJTable(String sql, Object... args) {
        return null;
    }
}
